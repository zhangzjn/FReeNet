...
parser.add_argument('--save_every', default=10, type=float, help='save the model every # epochs')
parser.add_argument('--every', default=60, type=float, help='learning rate decay')
...
# parser.add_argument('--save_every', default=100, type=float, help='save the model every # epochs')
# parser.add_argument('--every', default=600, type=float, help='learning rate decay')
